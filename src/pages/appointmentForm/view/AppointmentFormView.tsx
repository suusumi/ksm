                ...
                <Grid container direction="column" spacing={3} marginBottom={2}>
                    ...
                    {selectedForm === "main" ? (
                        <Grid container direction={"column"} spacing={3} marginBottom={2}>
                            ...
                            <Grid item xs={12}>
                                <Typography style={styles.text} mb={1}>
                                    ФИО
                                </Typography>
                                <TextField
                                    id="input-fio"
                                    ...
                                    onChange={(event) =>
                                        props.handleRegistrationsChange(event, "fio")
                                    }
                            ...
                            <Grid item xs={12}>
                                ...
                                >
                                    ...
                                    <OutlinedInput
                                        ...
                                        onChange={(event) =>
                                            props.handleRegistrationsChange(event, "phone")
                                        }
                            ...
                            <Grid item xs={12}>
                                ...
                                <TextField
                                    ...
                                    onChange={(event) =>
                                        props.handleRegistrationsChange(event, "doctor")
                                    }
                            ...
                            <Grid item xs={12}>
                                <Typography style={styles.text} mb={1}>
                                    Когда Вам удобно попасть на прием?
                                </Typography>
                            ...
                            <Grid item xs={12}>
                                ...
                                <TextField
                                    ...
                                    onChange={(event) =>
                                        props.handleRegistrationsChange(event, "comments")
                                    }
                                    InputProps={{sx: {borderRadius: "10px"}}}
                                />
                            </Grid>
                                            ...
                                            <FormControlLabel
                                                ...
                                                label={
                                                    <Typography textAlign={"center"}>
                                                        Отправляя данные, подтверждаю, что ознакомлен(а) и
                                                        согласен(согласна) с{" "}
                                                        <a
                                                            href="#"
                                                            style={{color: "rgb(8, 142, 129)"}}
                                    ...
                                    <Grid item>
                                        <Collapse in={props.openAllert}>
                                            {props.errorCreate && <Alert
                                                ...
                                                sx={{mb: 2}}
                                            >
                                                Что-то пошло не так, проверьте что все обязательные поля заполнены,
                                                данные
                                                введены вверно, и попробуйте еще раз!
                                            </Alert>}
                                            {!props.errorCreate && <Alert
                                                severity="success"
                                                action={
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                персональных данных, предпринимаемыеОБЩЕСТВО С ОГРАНИЧЕННОЙ
                                ОТВЕТСТВЕННОСТЬЮ "КЛИНИКА СЕМЕЙНОЙ МЕДИЦИНЫ"(далее — Оператор).
                                ...
                                о посетителях веб-сайта http://ksm.volgmed.ru 2. Основные
                                понятия, используемые в Политике 2.1. Автоматизированная
                                обработка персональных данных — обработка персональных данных с
                                помощью средств вычислительной техники. 2.2. Блокирование
                                ...
                                сети интернет по сетевому адресу http://ksm.volgmed.ru 2.4.
                                ...
                                или определяемому Пользователю веб-сайта http://ksm.volgmed.ru
                                ...
                                для распространения). 2.10. Пользователь — любой посетитель
                                веб-сайта http://ksm.volgmed.ru 2.11. Предоставление
                                персональных данных — действия, направленные на раскрытие
                                персональных данных определенному лицу или определенному кругу
                                лиц. 2.12. Распространение персональных данных — любые действия,
                                ...
                                каким-либо иным способом. 2.13. Трансграничная передача
                                ...
                                и/или уничтожаются материальные носители персональных данных. 3.
                                Основные права и обязанности Оператора 3.1. Оператор имеет
                                право: — получать от субъекта персональных данных достоверные
                                информацию и/или документы, содержащие персональные данные; — в
                                случае отзыва субъектом персональных данных согласия на
                                ...
                                предусмотренные Законом о персональных данных. 4. Основные права
                                и обязанности субъектов персональных данных 4.1. Субъекты
                                персональных данных имеют право: — получать информацию,
                                ...
                                РФ. 4.2. Субъекты персональных данных обязаны: — предоставлять
                                ...
                                обрабатываемых персональных данных соответствуют заявленным
                                целям обработки. Не допускается избыточность обрабатываемых
                                персональных данных по отношению к заявленным целям их
                                обработки. 5.6. При обработке персональных данных обеспечивается
                                ...
                                неточных данных. 5.7. Хранение персональных данных
                                ...
                                иное не предусмотрено федеральным законом. 6. Цели обработки
                                персональных данных Цель обработки: информирование Пользователя
                                посредством отправки электронных писем. Персональные данные -
                                фамилия, имя, отчество,электронный адрес, номера телефонов, год,
                                месяц, дата и место рождения. Правовые основания - договоры,
                                ...
                                обезличивание персональных данных. 7. Условия обработки
                                персональных данных 7.1. Обработка персональных данных
                                ...
                                данным неуполномоченных лиц. 8.2. Персональные данные
                                ...
                                гражданско-правовому договору. 8.3. В случае выявления
                                ...
                                rauvolggmu@ya.ru с пометкой «Актуализация персональных данных».
                                ...
                                электронный адрес Оператора rauvolggmu@ya.ru с пометкой «Отзыв
                                согласия на обработку персональных данных». 8.5. Вся информация,
                                ...
                                поставщиков услуг. 8.6. Установленные субъектом персональных
                                ...
                                определенных законодательством РФ. 8.7. Оператор при обработке
                                персональных данных обеспечивает конфиденциальность персональных
                                данных. 8.8. Оператор осуществляет хранение персональных данных
                                ...
                                неправомерной обработки персональных данных. 9. Перечень
                                действий, производимых Оператором с полученными персональными
                                данными 9.1. Оператор осуществляет сбор, запись, систематизацию,
                                накопление, хранение, уточнение (обновление, изменение),
                                извлечение, использование, передачу (распространение,
                                предоставление, доступ), обезличивание, блокирование, удаление и
                                уничтожение персональных данных. 9.2. Оператор осуществляет
                                автоматизированную обработку персональных данных с получением
                                ...
                                предусмотрено федеральным законом. 12. Заключительные положения
                                ...
                                rauvolggmu@ya.ru 12.2. В данном документе будут отражены любые
                                ...
                                сети Интернет по адресу http://ksm.volgmed.ru
                            </Typography>
                        </div>
