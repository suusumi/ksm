   ...
   const theme = useTheme();
    ...
    {isXsScreen ? (
        <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', position: 'relative' }}>
            <Box component="img" sx={{ width: "50%", position: 'absolute', top: '24%', left: '54%', zIndex: 1 }} src={zubPngVectorMobile}></Box>
            <Box component="img" sx={{ width: "80%" }} alt='Зуб Андрей Владимирович' src={zubWelcomeBlockMobile}></Box>
            <Typography sx={{ ...TitleText, zIndex: 2 }}>{data[0]?.title || ''}</Typography>
        ...
        <>
            ...
            <Grid item xs={12} sm={6} md={6}>
                <Box component="img" sx={{ width: "100%" }} alt='Зуб Андрей Владимирович' src={zubWelcomeBlock2}></Box>
            </Grid>
        </>
    )}
    </Grid>
